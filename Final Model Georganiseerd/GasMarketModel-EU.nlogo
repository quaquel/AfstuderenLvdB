...
to createcountries
  create-countries 1 [ ;EU 0
    ...
    set totalimport 0
    set totalexport 0
    set LNGimportcapacity 5315411.747
  ...
  create-countries 1 [ ;Norway 28 1
    set xcor 7;8.4689
    set ycor 43;60.4720
    set region 1
    set EU 0
  ...
  create-countries 1 [ ;Switzerland 29 2
    set xcor 5;8.2275
    set ycor 21;46.8182
    set region 1
    set EU 0
  ...
  create-countries 1 [ ;Non-EU Balkan 30 3
    set xcor 20;17.6791
    set ycor 17;43.9159
    set region 1
    set EU 0
  ...
  create-countries 1 [ ;Turkey & Georgia 31 4
    set xcor 34;35.2433
    set ycor 12;38.9637
    set region 1
    set EU 0
  ...
  create-countries 1 [ ;North America 32 5
    set xcor -29
    set ycor 13
    set region 2
    set EU 0
  ...
  create-countries 1 [ ;South and Central America 33 6
    set xcor -29
    set ycor 2
    set region 3
    set EU 0
  ...
  create-countries 1 [ ;Russia 34 7
    set xcor 34;60
    set ycor 36;61.524
    set region 4
    set EU 0
  ...
  create-countries 1 [ ;Ukraine 35 8
    set xcor 32;31.1656
    set ycor 25;48.3794
    set region 4
    set EU 0
  ...
  create-countries 1 [ ;Belarus 36 9
    set xcor 27;27.9534
    set ycor 32;53.7098
    set region 4
    set EU 0
  ...
  create-countries 1 [ ;Other CIS 37 10
    set xcor 60;71.2761
    set ycor 21;38.8610
    set region 4
    set EU 0
  ...
  create-countries 1 [ ;Middle East 38 11
    set xcor 58;53.6880
    set ycor 6;32.4279
    set region 5
    set EU 0
  ...
  create-countries 1 [ ;Africa 39 12
    set xcor 3;1.6596
    set ycor 6;28.0339
    set region 6
    set EU 0
  ...
  create-countries 1 [ ;Asia-Pacific 40 13
    set xcor 70
    set ycor 10
    set region 7
    set EU 0
...
to resetlinks
  ...
  ask country 0 [;Belgium
    ...
    create-borderpipe-with country 1 ;Norway
    set linkedcountries lput 1 linkedcountries
    ask country 1 [set linkedcountries lput 0 linkedcountries]

    create-borderpipe-with country 2 ;Switzerland
    set linkedcountries lput 2 linkedcountries
    ask country 2 [set linkedcountries lput 0 linkedcountries]

    create-borderpipe-with country 3 ;Non-EU Balkan
    set linkedcountries lput 3 linkedcountries
    ask country 3 [set linkedcountries lput 0 linkedcountries]

    create-borderpipe-with country 4 ;Turkey & Georgia
    set linkedcountries lput 4 linkedcountries
    ask country 4 [set linkedcountries lput 0 linkedcountries]

    create-borderpipe-with country 7 ;Russia
    set linkedcountries lput 7 linkedcountries
    ask country 7 [set linkedcountries lput 0 linkedcountries]

    create-borderpipe-with country 8 ;Ukraine
    set linkedcountries lput 8 linkedcountries
    ask country 8 [set linkedcountries lput 0 linkedcountries]

    create-borderpipe-with country 9 ;Belarus
  ...
  ask country 7 [;Russia
    create-borderpipe-with country 4 ;Turkey & Georgia
    set linkedcountries lput 4 linkedcountries
    ask country 4 [set linkedcountries lput 7 linkedcountries]

    create-borderpipe-with country 8 ;Ukraine
    set linkedcountries lput 8 linkedcountries
    ask country 8 [set linkedcountries lput 7 linkedcountries]

    create-borderpipe-with country 9 ;Belarus
    set linkedcountries lput 9 linkedcountries
    ask country 9 [set linkedcountries lput 7 linkedcountries]

    create-borderpipe-with country 10 ;other CIS
    set linkedcountries lput 10 linkedcountries
    ask country 10 [set linkedcountries lput 7 linkedcountries]
  ]

  ask country 10 [;other CIS
    create-borderpipe-with country 3 ; Non-EU Balkan
    set linkedcountries lput 3 linkedcountries
    ask country 3 [set linkedcountries lput 10 linkedcountries]

    create-borderpipe-with country 4 ; Turkey and Georgia
    set linkedcountries lput 4 linkedcountries
    ask country 4 [set linkedcountries lput 10 linkedcountries]

    create-borderpipe-with country 11 ;Middle East
    set linkedcountries lput 11 linkedcountries
    ask country 11 [set linkedcountries lput 10 linkedcountries]

    create-borderpipe-with country 13 ;Asia-Pacific
    set linkedcountries lput 13 linkedcountries
    ask country 13 [set linkedcountries lput 10 linkedcountries]
  ]

  ask country 11 [;Middle East
    create-borderpipe-with country 4 ;Turkey & Georgia
    set linkedcountries lput 4 linkedcountries
    ask country 4 [set linkedcountries lput 11 linkedcountries]
  ]

  ask country 12 [;Africa
    create-borderpipe-with country 0 ;Spain
    set linkedcountries lput 0 linkedcountries
    ask country 0 [set linkedcountries lput 12 linkedcountries]
  ]

  ask borderpipe 0 1 [set capacity 4202284]
  ask borderpipe 0 2 [set capacity 794673]
  ask borderpipe 0 3 [set capacity 1479635]
  ask borderpipe 0 4 [set capacity 66722]
  ask borderpipe 0 7 [set capacity 3694134]
  ask borderpipe 0 8 [set capacity 800684]
  ask borderpipe 0 9 [set capacity 3703708]
  ask borderpipe 0 12 [set capacity 1481823]

  ask borderpipe 7 4 [set capacity 1262872]
  ask borderpipe 7 8 [set capacity 657959] ;assumed to be the same as other CIS
  ask borderpipe 7 9 [set capacity 657959]
  ask borderpipe 7 10 [set capacity 694923]
  ask borderpipe 10 3 [set capacity 77624]
  ask borderpipe 10 4 [set capacity 232873]
  ask borderpipe 10 11 [set capacity 85017]
  ask borderpipe 10 13 [set capacity 1338097]
  ask borderpipe 11 4 [set capacity 328980]
