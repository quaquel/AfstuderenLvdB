...
#     sd_model = pysd.read_vensim("modelV42.mdl")
    sd_model = pysd.load("modelV42.py")
#     print("Loading SD price model...")
#     price_model = pysd.read_vensim("EnergyPriceModelV3.mdl")
    price_model = pysd.load("EnergyPriceModelV3.py")
    
    if EnergyUnion == 0:
        netlogo = pyNetLogo.NetLogoLink(gui=False)
        netlogo.load_model(r'modelv41.nlogo')
        netlogo.command('setup')
        modelinput = pd.read_csv("testlanden12.csv")
        ...
        netlogo = pyNetLogo.NetLogoLink(gui=False)
        netlogo.load_model(r'modelv41-EU.nlogo')
        netlogo.command('setup')
        modelinput = pd.read_csv("testlanden12-EnU.csv")
        inputdict = modelinput.to_dict('index')
        ncountries = len(modelinput)
...
#     priceinputdict = priceinput.to_dict('index')[0]
    ...
    netlogoglobals = pd.read_csv("netlogoglobals3.csv")  
